      ...
      <form className="flex justify-center mt-4 gap-x-2" onSubmit={handleSubmit(onSubmit)}>
        <div className='flex flex-col gap-y-2'>
          ...
          <div className='flex mt-5'>
            ...
            <div className='flex mt-5'>
            <label htmlFor="password" className='text-left basis-28 flex justify-start items-center'>비밀번호</label>
            <input id='password' placeholder='비밀번호' type="password" className="w-[40vw] border border-slate-300 p-2" {...register("password", { required: true })} />
            </div>
            { errors.password &&
            <div className='flex'>
              <div className='basis-28'>&nbsp;</div>
            ...
            <input id='passwordConfirm' placeholder='비밀번호 확인' type="password" className="w-[40vw] border border-slate-300 p-2" {...register("passwordConfirm", { required: true })} />
            </div>
            { errors.password &&
            <div className='flex'>
              <div className='basis-28'>&nbsp;</div>
              <div className="text-red-500 font-extrabold">비밀번호를 다시 입력해주세요</div>
            </div> }

            <div className='flex mt-5'>
            <label htmlFor="email" className='text-left basis-28 flex justify-start items-center'>이메일</label>
            <input id='email' placeholder='이메일' type="email" className="w-[40vw] border border-slate-300 p-2" {...register("email", { required: true })} />
            </div>
            { errors.email &&
            <div className='flex'>
              <div className='basis-28'>&nbsp;</div>
            ...
            <div className='flex mt-5'>
              <label htmlFor="phone" className='text-left basis-28 flex justify-start items-center'>핸드폰번호</label>
              <input id='phone' placeholder='핸드폰번호' type="text" className="w-[40vw] border border-slate-300 p-2" {...register("phone", { required: true })} />
            </div>
            { errors.phone &&
            <div className='flex'>
              <div className='basis-28'>&nbsp;</div>
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.`
        ...
        <div className='text-left mt-14'>[필수] 개인정보 수집 및 이용 동의</div>
        <div className="border border-slate-300 p-4 m-4 h-80 overflow-scroll text-sm">
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.`
        ...
        <div className='text-left mt-14'>[선택] 쇼핑정보 수신 동의</div>
        <div className="border border-slate-300 p-4 m-4 h-30 overflow-scroll text-sm">
